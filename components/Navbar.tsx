    ...
    <>
      ...
      <nav className="w-full max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-4 text-sm">
          <Link to="https://www.ponsfamily.com/launchpad/0x0f197a3d703a298099533558b67807d7bcb0de6c" target="_blank" className="text-white hover:text-white/80 transition-colors font-bold">
            $LOBS
          </Link>
